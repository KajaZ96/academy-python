...
class MyTestCase(unittest.TestCase):
    ...
    def test_min_positive_mass(self):                 #wartość najmniejsza z możliwych
        self.assertEqual(1, calculate_fuel(1))


if __name__ == '__main__':         #klauzura, jeśli odpalasz dokładnie ten plik to wykonaj co jest pod nim, jeśli importowany to się nie wykona
    unittest.main()
